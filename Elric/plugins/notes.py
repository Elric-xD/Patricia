...
from Elric.db import database as db
from Elric import pbot as bot
from pyrogram import filters
import json
from Elric import help_message
from Elric.core.admin import is_admin
from Elric.utils.sendlog import send_log
...
def addnote(_, message):
    if is_admin(message.chat.id, message.from_user.id):
        ...
        message.reply_text('Note Added Successfully!')
